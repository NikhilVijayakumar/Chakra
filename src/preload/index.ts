...
const api = {
  ...
  dharma: {
    // Company management
    getCompanies: () => electronAPI.ipcRenderer.invoke('dharma:get-companies'),
    getCompany: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-company', { companyId }),
    getActiveCompany: () => electronAPI.ipcRenderer.invoke('dharma:get-active-company'),
    setActiveCompany: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:set-active-company', { companyId }),

    // Registry data - load from Dharma
    getAgents: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-agents', { companyId }),
    getAgent: (companyId: string, agentPath: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-agent', { companyId, agentPath }),
    getSkills: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-skills', { companyId }),
    getProtocols: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-protocols', { companyId }),
    getWorkflows: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-workflows', { companyId }),
    getKpis: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-kpis', { companyId }),
    getDataInputs: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-data-inputs', { companyId }),
    getProducts: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-products', { companyId }),
    getProduct: (companyId: string, productId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-product', { companyId, productId }),

    // Sync status - from SQLite
    getAgentsSyncStatus: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-agents-sync-status', { companyId }),
    getSkillsSyncStatus: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-skills-sync-status', { companyId }),
    getProtocolsSyncStatus: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-protocols-sync-status', { companyId }),
    getWorkflowsSyncStatus: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-workflows-sync-status', { companyId }),
    getKpisSyncStatus: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-kpis-sync-status', { companyId }),
    getDataInputsSyncStatus: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-data-inputs-sync-status', { companyId }),
    getProductsSyncStatus: (companyId: string) =>
      electronAPI.ipcRenderer.invoke('dharma:get-products-sync-status', { companyId }),

    // Save to vault - user triggered (SQLite → Vault workflow)
    syncAgentToCache: (companyId: string, agent: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:sync-agent-to-cache', { companyId, agent }),
    syncSkillToCache: (companyId: string, skill: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:sync-skill-to-cache', { companyId, skill }),
    syncProtocolToCache: (companyId: string, protocol: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:sync-protocol-to-cache', { companyId, protocol }),
    syncWorkflowToCache: (companyId: string, workflow: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:sync-workflow-to-cache', { companyId, workflow }),
    syncKpiToCache: (companyId: string, kpi: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:sync-kpi-to-cache', { companyId, kpi }),
    syncDataInputToCache: (companyId: string, dataInput: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:sync-data-input-to-cache', { companyId, dataInput }),
    syncProductToCache: (companyId: string, product: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:sync-product-to-cache', { companyId, product }),

    saveAgentToVault: (companyId: string, agent: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:save-agent-to-vault', { companyId, agent }),
    saveSkillToVault: (companyId: string, skill: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:save-skill-to-vault', { companyId, skill }),
    saveProtocolToVault: (companyId: string, protocol: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:save-protocol-to-vault', { companyId, protocol }),
    saveWorkflowToVault: (companyId: string, workflow: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:save-workflow-to-vault', { companyId, workflow }),
    saveKpiToVault: (companyId: string, kpi: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:save-kpi-to-vault', { companyId, kpi }),
    saveDataInputToVault: (companyId: string, dataInput: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:save-data-input-to-vault', { companyId, dataInput }),
    saveProductToVault: (companyId: string, product: unknown) =>
      electronAPI.ipcRenderer.invoke('dharma:save-product-to-vault', { companyId, product })
  }
}
